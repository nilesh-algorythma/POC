...
public class CloudResponseWithMeta {
    private static final String TAG = CloudResponseWithMeta.class.getSimpleName();
    ...
    public CloudResponseWithMeta(JSONObject response){
        try {
            ...
            if (response.has("meta") && !response.isNull("meta")) {
                ...
                Log.e("getCamsessRecords: meta not found");
            }

        }catch(JSONException e){
            Log.e("Invalid parse json");
            e.printStackTrace();
        }
    }
