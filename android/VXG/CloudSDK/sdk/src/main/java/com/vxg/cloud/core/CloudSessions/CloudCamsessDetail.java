...
public class CloudCamsessDetail {
    private static final String TAG = CloudCamsessDetail.class.getSimpleName();
    ...
    public CloudCamsessDetail(){
        mHasError = true;
    }

    public CloudCamsessDetail(JSONObject details){
        try {
            ...
            if (details.has("errorType") && details.has("errorDetail")) {
                ...
                if(details.has("preview") && !details.isNull("preview")){
                    ...
                    if(preview.has("time") && !preview.isNull("time")){
                        mPreviewTime = CloudHelpers.parseTime(preview.getString("time"));
                    }
